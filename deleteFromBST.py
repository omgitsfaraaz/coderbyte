...
# You're given a binary search tree t and an array of numbers queries. Your task is to
# remove queries[0], queries[1], etc., from t, step by step, following the algorithm above.
