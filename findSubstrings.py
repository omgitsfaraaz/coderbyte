...
# If several parts substrings occur in one string in words, choose the longest one. If there is
# still more than one such part, then choose the one that appears first in the string.
...
# While "Watermelon" contains three substrings from the parts array, "a", "mel", and
# "lon", "mel" is the longest substring that appears first in the string.
